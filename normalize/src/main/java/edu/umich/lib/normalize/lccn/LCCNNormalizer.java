 ...
 *
 * <p>Follows the normalization algorithm described at <a
 * href="http://www.loc.gov/marc/lccn-namespace.html#syntax">
 * http://www.loc.gov/marc/lccn-namespace.html#syntax</a>.
 *
 * <p>{@link #normalize(String)} always returns a non-null string. Inputs that do not match any
 * recognized LCCN pattern are returned lowercased with whitespace stripped, rather than throwing.
 *
...
public final class LCCNNormalizer {
   ...
   *
   * <p>Strips leading {@code http://lccn.loc.gov/} URIs, removes whitespace, lowercases, drops
   * everything after a slash, and zero-pads post-hyphen digits to six places. Inputs that do not
   * match a recognized LCCN pattern are returned lowercased with whitespace stripped rather than
   * throwing.
   *
