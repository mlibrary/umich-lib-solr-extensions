...
/**
 * A Solr/Lucene token filter that normalizes LC call number tokens to a sortable key string
 * suitable for both sort fields and left-anchored prefix search (when paired with an edge-ngram
 * filter).
 *
 * <p>Tokens that cannot be parsed as an LC call number return {@code null} from {@link
...
public final class LCCallNumberNormalizerFilter extends SimpleFilter {
   ...
   */
  public LCCallNumberNormalizerFilter(
