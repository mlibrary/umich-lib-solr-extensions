 ...
 *
 * <p>Normalizes LC or Dewey call number tokens to a sortable key string, suitable for sort fields
 * and (when combined with an edge-ngram filter) left-anchored prefix search.
 *
 ...
 *       cannot be parsed as a call number are passed through unchanged.
 * </ul>
 *
