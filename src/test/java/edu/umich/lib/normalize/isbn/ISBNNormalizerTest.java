...
class ISBNNormalizerTest {
    ...
    class Normalize {
        ...
        void isbn10_embeddedInText_extractedAndConverted() {
            assertEquals("9780306406157",
                    ISBNNormalizer.normalize("ISBN 0-306-40615-2 (hardcover)"));
        }
        ...
        @Test
        @DisplayName("String with digits that match pattern but wrong length after stripping returns null")
