...
class IsbnNormalizerLiveIT extends AbstractLiveIT {
  ...
  void isbn10WithDashesIndexesAsNormalizedIsbn13() throws Exception {
    ...
    List<String> ids = idsOf(client.query(new SolrTestQuery("isbn:9780306406157").setFields("id")));
  ...
  void invalidIsbnIsEchoedAsToken() throws Exception {
    ...
    List<String> ids = idsOf(client.query(new SolrTestQuery("isbn:0123456789").setFields("id")));
