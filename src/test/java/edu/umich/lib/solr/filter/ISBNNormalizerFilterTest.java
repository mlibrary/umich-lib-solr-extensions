 ...
 *
 * <p>Tests use a {@link WhitespaceTokenizer} source so each whitespace-delimited
 * token flows through {@link ISBNNormalizerFilter#munge(String)} independently.
 */
