 ...
 *
 * <p>Tokens that contain no recognizable ISBN pattern are dropped (or passed
 * through unchanged if {@code echoInvalidInput="true"} is set in schema.xml).
 * Diagnostic logging is handled by {@link ISBNNormalizer}.
 *
...
public class ISBNNormalizerFilter extends SimpleFilter {
     ...
     * @param echoInvalidInput when {@code true}, tokens that are not valid ISBNs
     ...
     *
     * @return the normalized ISBN-13, or {@code null} if {@code input} contains
